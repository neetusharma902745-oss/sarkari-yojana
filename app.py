...
articles = [
    {"id":1,"yojana_id":1,"title":"PM-KISAN योजना में कैसे करें आवेदन? पूरी जानकारी हिंदी में","slug":"pm-kisan-apply-kaise-kare","icon":"🌾","date":"27 फरवरी 2024","read_time":"5 मिनट","content":"<h2>PM-KISAN योजना क्या है?</h2><p>किसानों को प्रतिवर्ष <strong>₹6,000</strong> की सहायता तीन किस्तों में दी जाती है।</p><h2>पात्रता</h2><ul><li>लघु एवं सीमांत किसान (2 हेक्टेयर तक जमीन)</li><li>आधार कार्ड अनिवार्य</li><li>बैंक खाता आधार से linked हो</li></ul><h2>जरूरी दस्तावेज</h2><ul><li>📋 आधार कार्ड</li><li>🏦 बैंक पासबुक</li><li>🌾 खसरा/खतौनी</li><li>📱 मोबाइल नंबर</li></ul><h2>Online आवेदन</h2><ol><li>pmkisan.gov.in खोलें</li><li>Farmers Corner → New Farmer Registration</li><li>आधार नंबर डालें और OTP verify करें</li><li>सभी जानकारी भरें और submit करें</li></ol><h2>हेल्पलाइन</h2><p>📞 <strong>155261</strong></p>"},
    {"id":2,"yojana_id":2,"title":"PM Awas Yojana: घर के लिए ₹2.5 लाख सब्सिडी कैसे पाएं?","slug":"pmay-awas-yojana-apply","icon":"🏠","date":"26 फरवरी 2024","read_time":"6 मिनट","content":"<h2>PMAY क्या है?</h2><p>गरीब परिवारों को पक्का घर बनाने के लिए <strong>₹1.2 लाख से ₹2.5 लाख</strong> सब्सिडी मिलती है।</p><h2>पात्रता</h2><ul><li>EWS: सालाना आय ₹3 लाख से कम</li><li>LIG: सालाना आय ₹3-6 लाख</li><li>परिवार के नाम पहले से पक्का घर न हो</li></ul><h2>Online आवेदन</h2><ol><li>pmaymis.gov.in पर जाएं</li><li>Citizen Assessment click करें</li><li>आधार verify करें और form भरें</li></ol><h2>हेल्पलाइन</h2><p>📞 <strong>1800-11-6163</strong></p>"},
    {"id":3,"yojana_id":3,"title":"Ayushman Bharat Card: मुफ्त ₹5 लाख का इलाज कैसे पाएं?","slug":"ayushman-bharat-card-kaise-banaye","icon":"🏥","date":"25 फरवरी 2024","read_time":"5 मिनट","content":"<h2>आयुष्मान भारत क्या है?</h2><p>गरीब परिवारों को प्रति वर्ष <strong>₹5 लाख</strong> तक का मुफ्त इलाज मिलता है।</p><h2>क्या मिलता है?</h2><ul><li>अस्पताल में भर्ती का खर्च</li><li>ऑपरेशन और दवाइयां</li><li>1,393 बीमारियों का इलाज</li></ul><h2>Card कैसे बनाएं?</h2><ol><li>beneficiary.nha.gov.in खोलें</li><li>मोबाइल नंबर से login करें</li><li>आधार से eKYC करें</li><li>Card download करें</li></ol><h2>हेल्पलाइन</h2><p>📞 <strong>14555</strong></p>"},
    {"id":4,"yojana_id":5,"title":"मुद्रा लोन: बिना गारंटी ₹10 लाख का व्यवसाय ऋण कैसे लें?","slug":"mudra-loan-kaise-le","icon":"💼","date":"24 फरवरी 2024","read_time":"6 मिनट","content":"<h2>मुद्रा योजना क्या है?</h2><p>छोटे व्यवसायियों को <strong>बिना गारंटी</strong> ₹10 लाख तक का लोन मिलता है।</p><h2>तीन प्रकार</h2><ul><li>🐣 शिशु: ₹50,000 तक</li><li>🌱 किशोर: ₹50,000 से ₹5 लाख</li><li>🌳 तरुण: ₹5 लाख से ₹10 लाख</li></ul><h2>आवेदन</h2><ol><li>नजदीकी बैंक में जाएं</li><li>मुद्रा लोन form भरें</li><li>Documents जमा करें</li></ol><h2>हेल्पलाइन</h2><p>📞 <strong>1800-180-1111</strong></p>"},
    {"id":5,"yojana_id":7,"title":"मनरेगा Job Card: 100 दिन गारंटीड रोजगार कैसे पाएं?","slug":"mgnrega-job-card-kaise-banaye","icon":"⛏️","date":"23 फरवरी 2024","read_time":"4 मिनट","content":"<h2>मनरेगा क्या है?</h2><p>ग्रामीण परिवारों को <strong>100 दिन का गारंटीड रोजगार</strong> मिलता है।</p><h2>Job Card कैसे बनाएं?</h2><ol><li>ग्राम पंचायत में जाएं</li><li>Registration form भरें</li><li>आधार और फोटो जमा करें</li><li>15 दिन में Job Card मिलेगा</li></ol><h2>मजदूरी 2024</h2><ul><li>UP: ₹237/दिन | राजस्थान: ₹266/दिन</li></ul><h2>हेल्पलाइन</h2><p>📞 <strong>1800-111-555</strong></p>"},
    {"id":6,"yojana_id":6,"title":"सुकन्या समृद्धि: बेटी के लिए खोलें खाता, मिलेगा 8.2% ब्याज","slug":"sukanya-samriddhi-account-kaise-khole","icon":"👧","date":"22 फरवरी 2024","read_time":"5 मिनट","content":"<h2>सुकन्या समृद्धि क्या है?</h2><p>बेटियों के लिए <strong>8.2% प्रति वर्ष</strong> ब्याज वाली बचत योजना।</p><h2>खाता कैसे खोलें?</h2><ol><li>Post Office या SBI/PNB में जाएं</li><li>SSY form भरें</li><li>बेटी का birth certificate और आधार दें</li><li>₹250 जमा करके खाता खुलेगा</li></ol><h2>Maturity पर कितना मिलेगा?</h2><p>₹1.5 लाख/वर्ष जमा पर 21 साल बाद लगभग <strong>₹70 लाख</strong>!</p>"},
    {"id":7,"yojana_id":4,"title":"उज्ज्वला योजना: मुफ्त गैस कनेक्शन के लिए ऐसे करें आवेदन","slug":"ujjwala-yojana-free-gas-connection","icon":"🔥","date":"21 फरवरी 2024","read_time":"4 मिनट","content":"<h2>उज्ज्वला योजना क्या है?</h2><p>BPL महिलाओं को <strong>मुफ्त LPG कनेक्शन</strong> + ₹1,600 सहायता।</p><h2>आवेदन</h2><ol><li>नजदीकी LPG distributor जाएं</li><li>KYC form भरें</li><li>BPL card और आधार जमा करें</li></ol><h2>हेल्पलाइन</h2><p>📞 <strong>1906</strong></p>"},
    {"id":8,"yojana_id":8,"title":"जन धन खाता: Zero Balance + ₹2 लाख बीमा कैसे पाएं?","slug":"jan-dhan-account-kaise-khole","icon":"🏦","date":"20 फरवरी 2024","read_time":"4 मिनट","content":"<h2>जन धन योजना क्या है?</h2><p><strong>Zero Balance खाता</strong> + ₹2 लाख बीमा + ₹10,000 overdraft।</p><h2>खाता कैसे खोलें?</h2><ol><li>नजदीकी बैंक में जाएं</li><li>Jan Dhan form भरें</li><li>आधार और फोटो दें</li><li>उसी दिन खाता खुलेगा!</li></ol><h2>हेल्पलाइन</h2><p>📞 <strong>1800-11-0001</strong></p>"},
    {"id":9,"yojana_id":9,"title":"NSP Scholarship 2024: छात्रवृत्ति के लिए Online Apply कैसे करें?","slug":"nsp-scholarship-apply-online","icon":"🎓","date":"19 फरवरी 2024","read_time":"5 मिनट","content":"<h2>NSP Scholarship क्या है?</h2><p>SC/ST/OBC छात्रों को <strong>₹1,000 से ₹25,000</strong> तक छात्रवृत्ति।</p><h2>Online Apply</h2><ol><li>scholarships.gov.in खोलें</li><li>New Registration → आधार से register करें</li><li>Scholarship चुनें और form भरें</li><li>Documents upload करें</li></ol><h2>हेल्पलाइन</h2><p>📞 <strong>0120-6619540</strong></p>"},
]
...
FOOTER = """<footer><p>© 2024 <strong>भारत सरकार योजना पोर्टल</strong> | जानकारी के लिए आधिकारिक वेबसाइट देखें।</p></footer>"""
...
def index():
    ...
    <div class="search-row"><input type="text" id="si" placeholder="योजना खोजें..."><button onclick="window.location='/search?q='+document.getElementById('si').value">🔍 खोजें</button></div>
    <div class="filters">
